...
<body class="bg-gray-100 min-h-screen flex items-center justify-center px-4 py-10 font-sans">
    ...
    <div class="w-full max-w-md bg-white border border-gray-200 rounded-2xl p-10 shadow-sm">
        ...
        <div class="text-center mb-7">
            <h1 class="text-xl font-medium text-gray-900">Login</h1>
        ...
        <form action="{{ route('logins') }}" method="POST" novalidate>
            @csrf
...
Sign In            </button>
        ...
        <div class="text-center">
            <a href="/register" class="text-sm text-gray-800 underline underline-offset-2 hover:text-gray-600 transition">
                Register
            </a>
        </div>
